...
public class StaffController {
	...
	public String insert(HttpSession session){  // insert 占쏙옙占쏙옙占쏙옙占쏙옙 占싱듸옙
	...
	public String insert(StaffDto dto, MultipartFile picture,HttpSession session){  // DB占쏙옙 insert
		try{
