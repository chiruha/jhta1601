...
.style {
    ...
    height: 580px;
				...
				<div class="h2Box">
					<h2>압구정점</h2>
					<div class="eng">- The Fitness Apgujeong</div>
				</div>

<div id="myCarousel" class="carousel slide" data-ride="carousel" >
    <!-- Indicators -->
    <ol class="carousel-indicators" id="intro">
    ...
    <div class="carousel-inner" role="listbox" id="intro">
      <div class="item">
        <img src="resources/img/center/Apgujeong_01.jpg" alt="Apgujeong" width="1000" height="700">
      </div>

      <div class="item active">
        <img src="resources/img/center/Apgujeong_02.jpg" alt="Apgujeong" width="1000" height="700">
      </div>
    
      <div class="item">
        <img src="resources/img/center/Apgujeong_03.jpg" alt="Apgujeong" width="1000" height="700">
      </div>
...
<div id="band" class="container text-center">
	<div class="h3Box">
  		<h2>압구정점 운영시간/상담시간</h2>
	</div>
	
  	<h6>02-444-7582</h6>
  <p>- 더피트니스 압구정점에서는 친절한 고객상담을 약속드립니다.</p>
  ...
  <br>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>박재민</strong></p><br>
      <a href="#demo" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Apgujeong_01.jpg" id=aaa class="img-circle person" alt="몰랑이 1" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>문승아</strong></p><br>
      <a href="#demo2" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Apgujeong_02.jpg" class="img-circle person" alt="몰랑이 2" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>김동현</strong></p><br>
      <a href="#demo3" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Apgujeong_03.jpg" class="img-circle person" alt="몰랑이 3" width="255" height="255">
      </a>
...
<br>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class=""><a data-toggle="tab" href="#tab4" aria-expanded="true">신촌지점</a></li>
  	...
  	<li class="active"><a data-toggle="tab" href="#tab6" aria-expanded="false">압구정점</a></li>
  </ul>
  <br>
  ...
  <div class="tab-content">
    ...
    <div id="tab6" class="tab-pane fade in active">
      	<div><h3>압구정점 </h3><h6>02-444-7582</h6></div>
    </div>
  </div>
</div>
</div>
