...
.carousel-inner img {
    ...
    margin: auto;
				...
				<div class="h2Box">
					<h2>화정지점</h2>
					<div class="eng">- The Fitness hwajeong</div>
				</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" id="intro">
      <div class="item">
        <img src="resources/img/center/Hwajeong_01.jpg" alt="Hwajeong" width="1000" height="600">
      </div>

      <div class="item active">
        <img src="resources/img/center/Hwajeong_02.jpg" alt="Hwajeong" width="1000" height="600">
      </div>
    
      <div class="item">
        <img src="resources/img/center/Hwajeong_03.jpg" alt="Hwajeong" width="1000" height="600">
      </div>
...
<div id="band" class="container text-center">
	<div class="h3Box">
  		<h2>화정지점 운영시간/상담시간</h2>
	</div>
	
  	<h6>031-111-1234</h6>
  <p>- 더피트니스 화정지점에서는 친절한 고객상담을 약속드립니다.</p>
  ...
  <br>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>최지훈</strong></p><br>
      <a href="#demo" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Hwajeong_01.jpg" id=aaa class="img-circle person" alt="몰랑이 1" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>김다희</strong></p><br>
      <a href="#demo2" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Hwajeong_02.jpg" class="img-circle person" alt="몰랑이 2" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>김준영</strong></p><br>
      <a href="#demo3" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Hwajeong_03.jpg" class="img-circle person" alt="몰랑이 3" width="255" height="255">
      </a>
...
<script charset="UTF-8">
  ...
  <div class="tab-content">
    ...
    <div id="tab2" class="tab-pane fade in active">
    	<div><h3>화정지점 </h3><h6>031-111-1234</h6></div>
    </div>
