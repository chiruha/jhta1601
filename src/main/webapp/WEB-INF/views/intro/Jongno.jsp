...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" id="intro">
      <div class="item">
        <img src="resources/img/center/Jongno_01.jpg" alt="Apgujeong" width="1000" height="600">
      </div>

      <div class="item active">
        <img src="resources/img/center/Jongno_02.jpg" alt="Chicago" width="1000" height="600">
      </div>
    
      <div class="item">
        <img src="resources/img/center/Jongno_03.jpg" alt="Los Angeles" width="1000" height="600">
      </div>
...
<div id="band" class="container text-center">
	<div class="h3Box">
  	...
  	<h6>02-222-2224</h6>
  <p>- 더피트니스 종로점에서는 친절한 고객상담을 약속드립니다.</p>
  ...
  <br>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>김새롬</strong></p><br>
      <a href="#demo" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Jongno_01.jpg" id=aaa class="img-circle person" alt="몰랑이 1" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>전영한</strong></p><br>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>이상아</strong></p><br>
      <a href="#demo3" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Jongno_03.jpg" class="img-circle person" alt="몰랑이 3" width="255" height="255">
      </a>
  ...
  <div id="band" class="container text-center">
    ...
    <p>- 서울 종로구 종로역 103-57 The Fitness 종로점</p>
<!-- * Daum 지도 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
 <div class="col-sm-12">
...
<script charset="UTF-8">
  ...
  <ul class="nav nav-tabs">
    ...
    <li class="active"><a data-toggle="tab" href="#tab3" aria-expanded="false">종로지점</a></li>
  ...
  <div class="tab-content">
    ...
    <div id="tab3" class="tab-pane fade in active">
        <div><h3>종로지점 </h3><h6>02-222-2224</h6></div>
    </div>
