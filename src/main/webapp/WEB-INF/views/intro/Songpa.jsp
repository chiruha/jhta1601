...
#aaa:hover img{
    ...
    opacity: 0.9;
				...
				<div class="h2Box">
					<h2>송파지점</h2>
					<div class="eng">- The Fitness Songpa</div>
				</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" id="intro">
      <div class="item">
        <img src="resources/img/center/Songpa_01.jpg" alt="Apgujeong" width="1000" height="600">
      </div>

      <div class="item active">
        <img src="resources/img/center/Songpa_02.jpg" alt="Chicago" width="1000" height="600">
      </div>
    
      <div class="item">
        <img src="resources/img/center/Songpa_03.jpg" alt="Los Angeles" width="1000" height="600">
      </div>
...
<div id="band" class="container text-center">
	<div class="h3Box">
  		<h2>송파지점 운영시간/상담시간</h2>
	</div>
	
  	<h6>02-333-6514</h6>
  <p>- 더피트니스 송파지점에서는 친절한 고객상담을 약속드립니다.</p>
  ...
  <br>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>강민주</strong></p><br>
      <a href="#demo" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Songpa_01.jpg" id=aaa class="img-circle person" alt="몰랑이 1" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>곽도원</strong></p><br>
      <a href="#demo2" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Songpa_02.jpg" class="img-circle person" alt="몰랑이 2" width="255" height="255">
      </a>
    ...
    <div class="col-sm-4">
      <p class="text-center"><strong>김여울</strong></p><br>
      <a href="#demo3" data-toggle="collapse" id=aaa>
        <img src="resources/img/center/Tr_Songpa_03.jpg" class="img-circle person" alt="몰랑이 3" width="255" height="255">
      </a>
  ...
  <div id="band" class="container text-center">
    ...
    <p>- 서울 송파구 송파역 103-57 The Fitness 송파지점</p>
<!-- * Daum 지도 - 지도퍼가기 -->
<!-- 1. 지도 노드 -->
 	<div class="row">
...
<br>
  ...
  <ul class="nav nav-tabs">
    ...
    <li class=""><a data-toggle="tab" href="#tab4" aria-expanded="true">신촌지점</a></li>
  	<li class="active"><a data-toggle="tab" href="#tab5" aria-expanded="false">송파지점</a></li>
  ...
  <div class="tab-content">
    ...
    <div id="tab5" class="tab-pane fade in active">
      	<div><h3>송파정점 </h3><h6>02-333-6514</h6></div>
    </div>
